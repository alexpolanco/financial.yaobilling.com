...
class add_expense extends CI_Controller {
	...
	public function index(){
		...
		{
			$q = "INSERT INTO expense (company_id, customer_first_name,customer_email,customer_address,customer_city,customer_zipcode,customer_phone,contact_person,contact_person_phone,customer_is_active)
