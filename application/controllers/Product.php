...
class Product extends MY_Controller  { 
	...
	public function create()
	{
		...
		$this->form_validation->set_rules('txt_sub_category_id', 'Subcategoría id', 'required');
		$this->form_validation->set_rules('txt_product_name', 'Producto', 'required');
		$this->form_validation->set_rules('txt_product_serial_no', 'Código del producto', 'required');
		$this->form_validation->set_rules('txt_product_description', 'Descripción del producto', 'required');
		$this->form_validation->set_rules('txt_product_is_active', 'Está activo', 'required');
		if (empty($_FILES['txt_product_image_1']['name']))
		{
			$this->form_validation->set_rules('txt_product_image_1', 'Imagén del producto', 'required');
		}
