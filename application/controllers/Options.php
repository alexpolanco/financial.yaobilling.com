...
class Options extends MY_Controller  { 
	...
	public function create()
	{
		...
		$this->form_validation->set_rules('txt_option_name', 'Atributo', 'required');
		$this->form_validation->set_rules('txt_option_is_active', 'Está activo', 'required');
		...
		else
		{
			...
			$this->session->set_flashdata('msg','Datos insertado exitosamente');
			$this->index();
		}
	}
