...
class Category extends MY_Controller  { 
	...
	public function create()
	{
		...
		$this->form_validation->set_rules('txt_category_name', 'Subcategoría name', 'required');
		$this->form_validation->set_rules('txt_category_description', 'Descripción', 'required');
		$this->form_validation->set_rules('txt_category_is_active', 'Está activa', 'required');
