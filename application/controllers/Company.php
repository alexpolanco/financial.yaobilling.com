...
class Company extends MY_Controller  { 
	...
	public function __construct()
	{
		...
		$data['objcompany'] = $this->company_model->findOne($this->session->userdata('companyid'));
	}
	...
	*/
	...
	public function update()
	{
		...
		$this->form_validation->set_rules('txtfirst_name', 'Empresa', 'required');
		$this->form_validation->set_rules('txtRNC', 'RNC de la empresa', 'required');
