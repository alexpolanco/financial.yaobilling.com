                    ...
                    <div class='box box-primary' >
                      ...
                      <div class='box-body pad'>
                        <div class="input-group input-group-lg">    
                          ...
                          <input type="text" name="txtproduct_serialno" id="p_nm" class="form-control " value="" onblur="checkoption();" placeholder="Nombre del producto"  />
                      ...
                      <div class='box-body pad'>
                        <div class="form-group" id="addbutton">
                          <table id="order_products"  class="table table-bordered table-hover" border='0'>
                            <thead class="bg-blue">
                                <tr id="rowheader">
                                  <th align="center" width="25%">Producto</th>
                    ...
                    <div class='box box-primary' >
                      ...
                      <div class="col-md-8 back-wight">
                        <div class='box-body pad'>
                          <div class="col-md-4 back-wight">
                            <div class="form-group">
                               <label class="right-baju">Impuestos</label>
                               <label class="right-baju">(0%)</label>
                               <br /><br />
                            </div>
                            <div class="form-group">
                                <label class="right-baju">Otros impuestos (%)</label><br /><br />
                            </div>
                            <div class="form-group">
                                <label class="right-baju">Otros (%)</label><br /><br />
                            </div>
                            <div class="form-group">
                  ...
                  <div class='box box-primary' >
                    <div class='box-body pad'>
                      ...
                      <div class="input-group">    
                            <input type="text" name="typeahead"  id="skills" class="form-control" value="<?php echo $this->session->userdata('username'); ?>"  placeholder="Cliente" >
                    ...
                    <div class='box-body pad'>
                      ...
                      <div class="input-group"> 
                        <select name="txtbillno" id="bill_no"  class="form-control" >
                          <option value="">Seleccione Número de factura</option>
                        </select>
                      ...
                      <div class="form-group">
                        <table width="100%">
                          <tr>
                            <td><label>Descuento de la factura:</label></td>
                            <td align="right" ><a id="modal_entire_disc"  href="#entire_disc" class="btn btn-info" style="color:#FFF;">Establecer descuento</a></td>
                          </tr>
                        </table>
                      </div>
                      ...
                      <input type="button" title="Cancelar" value="Cancel" class="btn btn-danger" onclick="javascript:window.location.href='<?php echo base_url().'sales' ?>'" />
    ...
    <!--  Model Start -->
          ...
          <div id="addqty" class="popupContainer" style="display:none;">
                <header class="popupHeader">
                  <span class="header_title">Cantidad del producto</span>
       ...
       <div id="changediscount" class="popupContainer" style="display:none;">
                ...
                <section class="popupBody">
                  ...
                  <div class="social_login">
                    <div class="">
                         Descuento en %
                          <input type="text" name="txtdisc" id="discmodel" class="form-control " value="" onkeyup="datachange(this.value)" placeholder="Descuento del producto..." />
                          Descuento en pesos
                          <input type="text" class="form-control" name="txtdiscr" id="discrupee" value= "" onkeyup="datachangerupee(this.value)" placeholder=" Descuento en pesos..."/>
                          <br />
             ...
             <div id="entire_disc" class="popupContainer" style="display:none;">
                <header class="popupHeader">
                  <span class="header_title">Descuento de la factura</span>
                  <span id="close" class="modal_close"><i class="fa fa-times"></i></span>
                </header>
           ...
           <!-- Discount -->  
             <div id="changeqty" class="popupContainer" style="display:none;">
                <header class="popupHeader">
                  <span class="header_title">Cantidad del prodcuto</span>
                ...
                <section class="popupBody">
                  ...
                  <div class="social_login">
                    <div class="">
                          ...
                          Cliente :
                          <input type="text" name="txtfname" id="txtfname" class="form-control validate[required]" value=""  placeholder="Cliente..." required />
                           Correo electrónico :
...
function toggleDiv(divId) {
    ...
    if(htt == 'Mostrar Mesas')
    {
      $('#butcaption').html('Ocultar Mesas');
    }
    else
    {
      $('#butcaption').html('Mostrar Mesas');
    }
  ...
  function selected_bill_no()
  {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo base_url() ?>ajax/get_sales_order_id/index",
        data: {"<?php echo $this->security->get_csrf_token_name(); ?>":"<?php echo $this->security->get_csrf_hash(); ?>","name":"abc"}
         ...
         if(!(msgno)== false){
            $.ajax({
                type: "GET",
                url: "<?php echo base_url() ?>ajax/get_bill_name/index",
  ...
  function setentriedisc()
  {
    ...
    if(!isNaN(setdisc)){
      ...
      $.ajax({
          type: "GET",
          url: "<?php echo base_url() ?>ajax/set_data_sale_discount/index",
  ...
  { 
    ...
    if(!(String(name)==false))
    {
        $.ajax({
            type: "GET",
            url: "<?php echo base_url() ?>ajax/get_product_option_sales/index",
        ...
        if(!(String(addr)==false)){
          if(!(String(city)==false)){
            if(!(String(zip)==false) && /^\d{6}$/.test(zip)){
              if(!(String(phno)==false) && /^\d{10}$/.test(phno)){
                if(!(String(conper)==false)){
                  if(!(String(cphno)==false) &&  /^\d{10}$/.test(cphno)){
                    ...
                    $.ajax({
                        type: "GET",
                        url: "<?php echo base_url() ?>ajax/edit_customer/index",
              ...
              alert('Código postal, máximo 6 dígitos !!');
            }
          }
          else {
            alert('Ciudad !!');
  ...
  function editcust()
  {
    ...
    if(!(String(cust)==false)){
      ...
      $.ajax({
          type: "GET",
          url: "<?php echo base_url() ?>ajax/get_customer_id/index",
         ...
         if(!(String(msg)==false)){
           ...
           alert('Introduzca o seleccione eun Cliente !!');
  ...
  function addbillnumber()
  {
    ...
    if( String(billname) != '')
    {
              $.ajax({
                  type: "GET",
                  url: "<?php echo base_url() ?>ajax/add_bill_name/index",
    ...
    {
      alert('Introduzca el número de factura');
  ...
  function getbillno()
  {
    ...
    if(billname == '')
    {
      alert('Seleccione el número de factura !');
    }
    else
    {
  ...
  function editbillnumber()
  {
    ...
    if( String(billname) != '' && String(oldname) != '')
    {
              ...
              $.ajax({
                  type: "GET",
                  url: "<?php echo base_url() ?>ajax/edit_bill_name/index",
    ...
    //var _amt = parseInt($("#p_amount").val());
      ...
      if(!(String(_pid)==false)){
          if (!(String(_qty)==false) && _qty > 0){  
              ...
              $.ajax({
                  type: "GET",
                  url: "<?php echo base_url() ?>ajax/get_product_data_sale/index",
...
//      document.getElementById('sales_tax_value').value = s_tax;
  ...
  function selectBill(table)
  {
    ...
    $.ajax({
         ...
         url: "<?php echo base_url() ?>ajax/Store_tmp_data/index",
...
// get sub category
  function getsubcategory(id)
  {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url() ?>ajax/getsubcategory/index",
...
//get product
  ...
  {     
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url() ?>ajax/getproduct/index",
