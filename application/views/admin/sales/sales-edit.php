                    ...
                    <div class='box box-primary' >
                      ...
                      <div class='box-body pad'>
                        <div class="input-group input-group-lg">    
                          ...
                          <input type="text" name="txtproduct_serialno" id="p_nm" class="form-control " value="" onblur="checkoption();" placeholder="Item Serial Number"  />
                          <span class="input-group-addon  btn btn-success btn-flat" style="background-color: green;">
                            ...
                            <input type="checkbox" value="yes" name="return" <?php if($checkreturn == 'yes') echo 'checked'; ?> /> <span style="color:#FFF;" > Devolver</span>
                                  ...
                                  if($recored != ''){
                                    ...
                                    foreach($recored as $_bill)
                                    {
                                      ...
                                      ?>
                                            ...
                                            <strong>Descuento total</strong><input type="hidden" value="Discount" name="select_order_products_name[]" />
                      ...
                      <div class="col-md-8 back-wight">
                        <div class='box-body pad'>
                          <div class="col-md-4 back-wight">
                            ...
                            <div class="form-group">
                                <label class="right-baju">Otro (%)</label><br /><br />
                            </div>
                            <div class="form-group">
                                <label class="right-baju">Total General</label>
                            </div>
                          </div>
                          <div class="col-md-8 back-wight">
                ...
                <div class="col-md-2 info-for-bill">
                  <div class='box box-primary' >
                      ...
                      <div class="form-group">
                        <label>Cash / Debit</label><br />
                          <select name="selcd_for" id="selcd_for"  class="form-control" required="required">
                            ...
                            <option value="Cash" <?php if($pay == 'Cash') echo 'selected';  ?> selected >Efectivo</option>
                            <option value="Debit" <?php if($pay == 'Debit') echo 'selected';  ?>>Tarjeta</option>
                          </select>
                      </div>
                    </div>
                    ...
                    <div class='box-body pad'>
                      ...
                      <input type="button" title="Cancelar" value="Cancelar" class="btn btn-danger" onclick="javascript:window.location.href='<?php echo base_url().'sales' ?>'" />
...
function toggleDiv(divId) {
              ...
              if(!(String(phno)==false) && /^\d{10}$/.test(phno)){
                if(!(String(conper)==false)){
                  if(!(String(cphno)==false) &&  /^\d{10}$/.test(cphno)){
                    ...
                    alert('ValidarTeléfono de la persona de contacto !!');
                  }
                }
                else{
  ...
  function deleteprd(id){  
    if(confirm('¿Seguro que desea eliminar este produto de la orden?')){
      //var _orders = $('#select_order_products').val();
