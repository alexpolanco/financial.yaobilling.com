...
// create some HTML content
	...
	<table width="100%" border="1"> 
			<tr align="left">
      	<td width="75%"><h1>'. $company[0]->company_name.'</h1>&nbsp;'.$company[0]->company_address.' '.$company[0]->company_city. '<br />&nbsp;'.$company[0]->company_phone.'</td>
	...
	<table style="border:1px solid black;" width="100%">
		<tr>
			<td height="20" align="center"><h3>FACTURA PARA CONSUMIDORES</h3> </td>
			</tr>	
	</table>
	...
	<table style="border:1px solid black;" width="100%" >
		...
		<th style="width:11%;border:1px solid black;" align="right"><h3>Cant.</h3></th>
		<th style="width:12%;border:1px solid black;" align="left"><h3>Unidad</h3></th>
		<th style="width:11%;border:1px solid black;" align="right"><h3>Precio</h3></th>
		<th style="width:11%;border:1px solid black;" align="right"><h3>Total</h3></th>
	</tr>
		';
		...
		$output .='<tr>
			...
			<table width="100%">
				<tr>
					<td align="left" width="75%">IMPUESTO 1 : '.$company[0]->company_vat_no.'</td>
								<td width="5%">:</td>
					<td align="right" width="20%">'.$company[0]->sales_tax1.'%</td>
				</tr>
				<tr>
					<td align="left">IMPUESTO 2 :'. $company[0]->company_cst_no.'</td>
								<td>:</td>
					<td align="right">'.$company[0]->sales_tax2.'%</td>
				</tr>
				<tr>
					<td align="left">IMPUESTO 3 : '.$company[0]->company_gst_no.'</td>
								<td>:</td>
		...
		<td colspan="2"  height="20" align="right" style="border:1px solid black;">
			<table width="100%">
				<tr>
					<td align="left" width="75%">IMPUESTO 1 ('.$company[0]->sales_tax1.'%)</td>
								<td width="5%">:</td>
					<td align="right" width="20%">'.$tax_total_price1.'</td>
				</tr>
				<tr>
					<td align="left">IMPUESTO 2 ('.$company[0]->sales_tax2.'%)</td>
								<td>:</td>
					<td align="right">'.$tax_total_price2.'</td>
				</tr>
				<tr>
					<td align="left">IMPUESTO 3 ('.$company[0]->sales_tax3.'%)</td>
								<td>:</td>
    ...
    <table border="1" width="100%">
      ...
      <tr>
      	<td colspan="4"  height="20">SOLO '.strtoupper($CI->convertNum($grand_tot)).'</td>
      </tr>
      <tr>
