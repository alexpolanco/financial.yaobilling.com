...
?>
  ...
  <?php echo form_open('loanschristmas/create', array('onsubmit' => 'return stopform();','id' => 'frm','name'=>'frm'));?>

    <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>Agregar Préstamo de Regalía</h1>
      <div class="breadcrumb">
        <input type="submit" name="btnsubmit" id="fsubmit" class="btn btn-lg btn-primary" value="Guardar" />
        <input type="button" title="Regresar" value="Regresar" class="btn btn-lg btn-warning" onclick="javascript:window.location.href='<?php echo base_url().'loanschristmas' ?>'" />
      </div>
    </section>
    <!-- Main content -->
            ...
            <div class='box box-primary'  >
                  <div class='box-body pad'>
                      ...
                      <div class="input-group input-group-lg">    
                        ...
                        <input type="number" name="txt_loans_amount" id="txt_loans_amount" class="form-control " value="0" onChange="updateLoanDates()" onkeypress="return tabE(this,event,'txt_loanstype_interes')" min="0" placeholder="Monto prestado..."  />
                      </div>
                      <br />
                      <div class="input-group input-group-lg">
                        <div class="input-group-btn">
                          <button type="button" class="btn btn-default dropdown-toggle">Monto de intéres</button>
                        </div>
                        <input type="number" name="txt_loanstype_interes" id="txt_loanstype_interes" class="form-control" value="0" onChange="updateLoanDates()" onkeypress="return tabE(this,event,'txt_contract_number')" min="0" placeholder="Intéres..." />
                      </div>
                      <br />
                        <div class="row">
                          <div class="col-md-12">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              <div class="input-group input-group-lg">    
                                ...
                                <input type="time" name="txt_entry_time" id="txt_entry_time" class="form-control " value="<?php echo date('H:i') ?>" onkeypress="return tabE(this,event,'txt_guarantor1')" min="0" placeholder="Hora del contrato..."  />
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              <div class="input-group input-group-lg">    
                                ...
                                <input type="date" name="txt_end_date" id="txt_end_date" class="form-control " value="<?php echo date('Y-12-12') ?>" min="0" placeholder="Fecha de vencimiento..." readonly  />
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            <div class="input-group input-group-lg">
                              <div class="input-group-btn">
                                <button type="button" class="btn btn-default dropdown-toggle">Cantidad de meses</button>
                              </div>
                              <input type="number" name="txt_loanstype_duration" id="txt_loanstype_duration" class="form-control " value="12" min="1" placeholder="Cantidad de meses..." readonly />
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="col-md-6 info-for-bill">
                  <div class='box box-primary' >
                    <div class='box-body pad'>
                        ...
                        <input type="hidden" name="txt_loanstype_id" id="txt_loanstype_id" value="3" />
                        <input type="hidden" name="txt_routes_id" id="txt_routes_id" value="<?php echo $_routes[0]->routes_id; ?>" />
                    
                      <p class="lead text-left">Amortización del préstamo</p>
                      <div id="loan_intro"></div>
...
// update loan dates
  ...
  {
    $("#txt_loanstype_duration").val(monthDiffToDecember(new Date($("#txt_entry_date").val())));

    var days = 0, _table, _loopdates, 
        _loans_amount = $("#txt_loans_amount").val(), 
        _interes = 1,
        _duration = $("#txt_loanstype_duration").val(), 
        _interes_amount = $("#txt_loanstype_interes").val(), 
    ...
    _table += '<tr><td>Inicio</td><td>'+$("#txt_entry_date").val()+'</td><td>'+addCommas(_loans_amount)+'</td><td></td><td></td></tr>';
    _loans_total += (_interes_amount/_duration);
    ...
    for (i = 0; i < _duration; i++)
    {
        ...
        _table += '<td></td>';
        _table += '<td>'+addCommas(_interes_amount/_duration)+'</td>';
    ...
    _table += '<td>'+addCommas(parseFloat(_interes_amount) + parseFloat(_loans_amount))+'</td>';
    _table += '</tr>';
    ...
    _table_intro = '<table class="table table-striped table-bordered table-hover"><tbody><tr><th style="width: 10px">Duración</th><th>Monto prestado</th><th>Monto de interes</th><th>Saldo regalía</th></tr>';

    _table_intro += '<tr><td>'+_duration+' meses</td><td>'+addCommas(_loans_amount)+'</td><td>'+addCommas(_interes_amount)+'</td><td>'+addCommas(parseFloat(_interes_amount) + parseFloat(_loans_amount))+'</td></tr></table><br>';

    $("#loan_intro").html(_table_intro);
...
// set loanstype
  ...
  function monthDiffToDecember(date) {
    var dt = new Date(new Date().getFullYear(), 12, 12), months;
