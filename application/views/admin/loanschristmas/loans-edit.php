...
<!-- Content Wrapper. Contains page content -->
  ...
  <?php echo form_open('loanschristmas/update/'.$this->uri->segment(3), array('onsubmit' => 'return stopform();','id' => 'frm','name'=>'frm'));?>

    <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>Editar Préstamo de Regalía <b><?php echo $recored[0]->customer_first_name; ?></b></h1>
      <div class="breadcrumb">
        ...
        <input type="hidden" name="product_serial_no" id="product_serial_no" value="<?php echo $recored[0]->loans_no; ?>" />
        <input type="hidden" name="loans_no" id="loans_no" value="<?php echo $recored[0]->loans_no; ?>" />
          ...
          <div class='box box-primary'  >
            <div class='box-body pad'>
                ...
                <div class="row" id="customers" style="display:none;">
                  ...
                  <div class="input-group input-group-lg">    
                    <div class="input-group-btn">
                      <button type="button" class="btn btn-default bg-gray color-palette dropdown-toggle">Total prestado</button>
                    </div>
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="row">
                          ...
                          <div class="input-group input-group-lg">
                            ...
                            <input type="number" name="txt_loanstype_duration" id="txt_loanstype_duration" class="form-control " value="<?php echo $recored[0]->duration; ?>" min="1" placeholder="Cantidad de meses..." readonly />
                          </div>
