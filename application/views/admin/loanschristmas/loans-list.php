...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Préstamos de Regalías <?php echo empty($loansdue) ? 'activos' : $loansdue ; ?> (<?php echo count($recored); ?>)</h1>
      <div class="breadcrumb">
        <?php if($loans_origen == 'due') : ?>
        <a id="loans" href="<?php echo base_url().'loanschristmas'; ?>" class="btn btn-lg btn-success">Préstamos activos</a>
        <?php else : ?>
        <a id="loans_due" href="<?php echo base_url().'loanschristmas/due'; ?>" class="btn btn-lg btn-danger">Préstamos saldados</a>
				<?php endif; ?>
        <!-- <a id="receipts" href="<?php echo base_url().'loanschristmas/receipt'; ?>" class="btn btn-lg btn-success">Recibos</a> -->
        <a id="new_loan" href="<?php echo base_url().'loanschristmas/create'; ?>" class="btn btn-lg btn-primary">Nuevo Préstamo</a> 
      </div>
    </section>
        ...
        <div class="col-md-12">
            <div class="box box-primary">
              ...
              <?php 
                ...
                echo form_open('loanschristmas/delete',$attributes) ?>
                <table id="example" class="display table cell-border row-border hover" style="width:100%">
                  ...
                  <tr data-child-value="<?php echo $_recored->loans_no; ?>" data-child-name="<?php echo  $_recored->customer_first_name; ?>" data-child-loans_amount="<?php echo $_recored->loans_amount; ?>"  data-child-current_balance="<?php echo $loanstotal_capital; ?>" data-child-interes_amount="<?php echo $_recored->interes_amount; ?>" data-child-capital="<?php echo $_recored->capital; ?>" data-child-interes="<?php echo $_recored->interes; ?>" data-child-unpaid_payments="<?php echo $_recored->unpaid_payments; ?>" data-child-due_date="<?php echo date("d-m-Y", strtotime($_recored->due_date)); ?>" >
                      ...
                      <td><?php echo number_format(floatval($loanstotal) + floatval($_recored->interes_amount) + floatval($_recored->unpaid_payments) - floatval($_recored->capital_paid), 2); ?></td>
                      <td></td>
                    </tr>
                  <?php 
                    }
      ...
      <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
          ...
          <?php 
                ...
                echo form_open('loanschristmas/pay',$attributes) ?>
      ...
      <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
          ...
          <?php 
                ...
                echo form_open('loanschristmas/additional',$attributes) ?>
                <div class="modal-body">
...
<div class="modal modal-success fade in" tabindex="-1" role="dialog" id="completeLoanModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      echo form_open('loanschristmas/edit/completeLoan',$attributes) ?>
        <div class="modal-body">
...
<div class="modal modal-danger fade in" tabindex="-1" role="dialog" id="removeTransactionModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      echo form_open('loanschristmas/delete/removeTransaction',$attributes) ?>
        <div class="modal-body">
...
<div class="modal modal-danger fade in" tabindex="-1" role="dialog" id="removeAdditionalModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      echo form_open('loanschristmas/delete/removeAdditional',$attributes) ?>
        <div class="modal-body">
...
function format(value, name, loans_amount, current_balance, interes_amount, capital, interes, unpaid_payments, due_date) {
  base_url = '<?php echo base_url() ?>loanschristmas/';
  ...
  {
    url = '<?php echo base_url() ?>loanschristmas/pdf/loan_letter/'+_loanno;
  ...
  {
    url = '<?php echo base_url() ?>loanschristmas/pdf/loan_1/'+_loanno;
  ...
  {
    url = '<?php echo base_url() ?>loanschristmas/pdf/loan_contract/'+_loanno;
  ...
  {
    url = '<?php echo base_url() ?>loanschristmas/pdf/loan_receipt/'+_loanno+'/'+_transno;
  ...
  function updateOrderTransactionsTable(id, due = "")
  {
    if(id) {
      $.ajax({
          type: "GET",
          url: "<?php echo base_url() ?>ajax/getloanschristmastransactions/index",
          data: {"<?php echo $this->security->get_csrf_token_name(); ?>":"<?php echo $this->security->get_csrf_hash(); ?>",'id':id}
      }).done(function( msg ) { 
  ...
  function updateAdditionalTable(id)
  {
    if(id) {
      $.ajax({
          type: "GET",
          url: "<?php echo base_url() ?>ajax/getloanschristmasadditional/index",
          data: {"<?php echo $this->security->get_csrf_token_name(); ?>":"<?php echo $this->security->get_csrf_hash(); ?>",'id':id}
      }).done(function( msg ) { 
