...
?>
  ...
  <?php echo form_open('loanscapital/create', array('onsubmit' => 'return stopform();','id' => 'frm','name'=>'frm'));?>
    ...
    <section class="content-header">
      <h1>Renovar Préstamo <b><?php echo $recored[0]->customer_first_name; ?></b></h1>
          ...
          <div class='box box-primary'  >
            <div class='box-body pad'>
                ...
                <div class="row" id="customers" style="display:none;">
                  ...
                  <div class="input-group input-group-lg">
                    <div class="input-group-btn">
                      <button type="button" class="btn btn-default dropdown-toggle">Cuota mensual</button>
                    </div>
                    <input type="number" name="txt_loanstype_interes" id="txt_loanstype_interes" class="form-control " value="<?php echo $recored[0]->interes; ?>" onChange="updateLoanDates()" onkeypress="return tabE(this,event,'txt_loanstype_frequency')" min="0" placeholder="Tasa de intéres..." /> 
                  </div>
                  <br /> 
                  <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group">
                            <div class="input-group input-group-lg">    
                              ...
                              <input type="date" name="txt_start_date" id="txt_start_date" class="form-control " value="<?php echo $recored[0]->start_date; ?>" onkeypress="return tabE(this,event,'fsubmit')" onChange="updateLoanDates()" min="0" placeholder="Fecha de inicio..."  />
                            </div>
                          </div>
                          </div></div>
                          <div class="row">
