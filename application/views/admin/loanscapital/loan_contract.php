...
<b>COMPARECE</b>: de una parte '.$debtorSexHonor.' <b><span style="text-transform:uppercase">'.$customer_first_name.Trim().'</span></b>, '.$order[0]->customer_nationality.', mayor de edad, '.$order[0]->customer_civilstatus.', '.$order[0]->customer_occupation.', titular de la cédula de identidad personal y electoral número
