...
?>
  ...
  <?php echo form_open('loanscapital/update/'.$this->uri->segment(3), array('onsubmit' => 'return stopform();','id' => 'frm','name'=>'frm'));?>

    <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>Editar Préstamo Capital e Interes <b><?php echo $recored[0]->customer_first_name; ?></b></h1>
            ...
            <div class='box-body pad'>
                ...
                <div class="row" id="customers" style="display:none;">
                  ...
                  <div class="input-group input-group-lg">
                    ...
                    <input type="number" name="txt_loanstype_interes" id="txt_loanstype_interes" class="form-control " value="<?php echo $recored[0]->interes_amount; ?>" onChange="updateLoanDates()" onkeypress="return tabE(this,event,'txt_interes')" min="0" placeholder="Tasa de intéres..." /> 
                  </div>
                  <br /> 
                  ...
                  <div class="input-group input-group-lg">
                    ...
                    <input type="number" name="txt_interes" id="txt_interes" class="form-control" value="<?php echo $recored[0]->interes; ?>" onChange="updateLoanDates()" onkeypress="return tabE(this,event,'txt_capital')" min="0" placeholder="Tasa de intéres..." />
                  </div>
                  <br /> 
                  <div class="input-group input-group-lg">
                    <div class="input-group-btn">
                    ...
                    <input type="number" name="txt_capital" id="txt_capital" class="form-control" value="<?php echo $recored[0]->capital; ?>" onChange="updateLoanDates()" onkeypress="return tabE(this,event,'txt_loanstype_frequency')" min="0" placeholder="Tasa de intéres..." />
                  </div>
                  <br />
                  <div class="row">
                    <div class="col-md-12">
                          ...
                          <div class="input-group input-group-lg">    
                            <div class="input-group-btn">
                              <label class="btn btn-primary">Fecha del contrato</label>
                                ...
                                <input type="date" name="txt_entry_date" id="txt_entry_date" class="form-control " value="<?php echo $recored[0]->entry_date; ?>" onkeypress="return tabE(this,event,'txt_entry_time')" min="0" placeholder="Fecha del contrato..."  />
                              </div>
                            </div>
                          </div>
                        </div>                        
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              <div class="input-group input-group-lg">    
                                ...
                                <input type="time" name="txt_entry_time" id="txt_entry_time" class="form-control " value="<?php echo $recored[0]->entry_time; ?>" onkeypress="return tabE(this,event,'txt_start_date')" min="0" placeholder="Hora del contrato..."  />
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="form-group">
                            <div class="input-group input-group-lg">    
                              ...
                              <input type="date" name="txt_start_date" id="txt_start_date" class="form-control " value="<?php echo $recored[0]->start_date; ?>" onkeypress="return tabE(this,event,'txt_guarantor1')" onChange="updateLoanDates()" min="0" placeholder="Fecha de inicio..."  />
                            </div>
                          </div>
                          </div></div>
                          <div class="row">
...
// update loan dates
  function updateLoanDates(){
    var days = 0, _table, _loopdates, 
        ...
        i, _table = '<table class="table table-striped table-bordered table-hover"><tbody><tr><th style="width: 10px">#</th><th>Fecha</th><th>Saldo inicial</th><th>Interes</th><th>Capital</th><th>Cuota fija</th><th>Saldo final</th></tr>';
    ...
    _table += '<tr><td>Inicio</td><td>'+$("#txt_entry_date").val()+'</td><td>'+addCommas(_loans_amount)+'</td><td></td><td></td><td></td><td>'+addCommas(_duration*(parseFloat(_interes_amount)+parseFloat(_capital_amount)))+'</td></tr>';
