...
?>
  ...
  <?php echo form_open('loanscapital/create', array('onsubmit' => 'return stopform();','id' => 'frm','name'=>'frm'));?>

    <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Agregar Préstamo Capital e Interes
      </h1>
      <div class="breadcrumb">
        <input type="submit" name="btnsubmit" id="fsubmit" class="btn btn-lg btn-primary" value="Guardar" />
        <input type="button" title="Regresar" value="Regresar" class="btn btn-lg btn-warning" onclick="javascript:window.location.href='<?php echo base_url().'loanscapital' ?>'" />
      </div>
    </section>
    <!-- Main content -->
                  ...
                  <div class='box box-primary'  >
                        <div class='box-body pad'>
                            ...
                            <div class="input-group input-group-lg">    
                              ...
                              <input type="number" name="txt_loans_amount" id="txt_loans_amount" class="form-control " value="" onKeyUp="updateLoanDates()" onkeypress="return tabE(this,event,'txt_loanstype_interes')" min="0" placeholder="Monto prestado..."  />
                            </div>
                            <br />   
                            <div class="input-group input-group-lg">
                              <div class="input-group-btn">
                                <button type="button" class="btn btn-default dropdown-toggle">Monto de la cuota</button>
                              </div>
                              <input type="number" name="txt_loanstype_interes" id="txt_loanstype_interes" class="form-control" value="0" onChange="updateLoanDates()" onkeypress="return tabE(this,event,'txt_interes')" min="0" placeholder="Pago mensual..." />
                            </div>
                            <br /> 
                            <div class="input-group input-group-lg">
                              <div class="input-group-btn">
                                <button type="button" class="btn btn-default dropdown-toggle">Pago al interes</button>
                              </div>
                              <input type="number" name="txt_interes" id="txt_interes" class="form-control" value="0" onChange="updateLoanDates()" onkeypress="return tabE(this,event,'txt_capital')" min="0" placeholder="Tasa de intéres..." />
                            </div>
                            <br /> 
                            <div class="input-group input-group-lg">
                              <div class="input-group-btn">
                                <button type="button" class="btn btn-default dropdown-toggle">Pago al capital</button>
                              </div>
                              <input type="number" name="txt_capital" id="txt_capital" class="form-control" value="0" onChange="updateLoanDates()" onkeypress="return tabE(this,event,'txt_loanstype_frequency')" min="0" placeholder="Tasa de intéres..." />
                            </div>
                            <br /> 
                            <div class="row">
                                <div class="col-md-12">
                                    <div id="title-loanstype">
                                        <div class="input-group input-group-lg">    
                                          ...
                                          <input type="text" name="txt_loanstype_frequency" id="txt_loanstype_frequency" class="form-control " value="Mensual" onkeypress="return tabE(this,event,'txt_loanstype_duration')" min="0" placeholder="Tipo de préstamo..."  readonly />
                                        </div>
                                    </div>
                                </div>
                            </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              <div class="input-group input-group-lg">    
                                ...
                                <input type="text" name="txt_contract_number" id="txt_contract_number" class="form-control " value="" onkeypress="return tabE(this,event,'txt_contract_folio1')" min="0" placeholder="Número de acto autentico..."  />
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              <div class="input-group input-group-lg">    
                                ...
                                <input type="text" name="txt_contract_folio1" id="txt_contract_folio1" class="form-control " value="" onkeypress="return tabE(this,event,'txt_contract_folio2')" min="0" placeholder="Número de folio 1..."  />
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              <div class="input-group input-group-lg">    
                                ...
                                <input type="text" name="txt_contract_folio2" id="txt_contract_folio2" class="form-control " value="" onkeypress="return tabE(this,event,'txt_entry_date')" min="0" placeholder="Número de folio 2..."  />
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="form-group">
                            <div class="input-group input-group-lg">    
                              ...
                              <input type="date" name="txt_entry_date" id="txt_entry_date" class="form-control " value="<?php echo date('Y-m-d') ?>" onkeypress="return tabE(this,event,'txt_entry_time')" onChange="updateLoanDates()" min="0" placeholder="Fecha del contrato..."  />
                            </div>
                          </div>
                          </div></div>
                        ...
                        <div class="row">
                          ...
                          <div class="form-group">
                            <div class="input-group input-group-lg">    
                              ...
                              <input type="date" name="txt_start_date" id="txt_start_date" class="form-control " value="<?php echo date('Y-m-d') ?>" onkeypress="return tabE(this,event,'txt_guarantor1')" min="0" placeholder="Fecha de inicio..."  />
                            </div>
                          </div>
                          </div></div>
                          <div class="row">
                ...
                <div class="col-md-6 info-for-bill">
                  <div class='box box-primary' >
                    <div class='box-body pad'>
                      ...
                      <input type="hidden" name="txt_cuota_amount" id="txt_cuota_amount" value="0" />
                      <input type="hidden" name="txt_capital_amount" id="txt_capital_amount" value="0" />
                    ...
                    <div class='box-body pad'>
                      <div class="form-group">
                          <input type="textarea" name="txt_comments" id="txt_comments" class="form-control " value="" placeholder="Comentario o aclaración..."  />
                      </div>
                    </div>
                    <div class='box-body pad'>
...
// update loan dates
  function updateLoanDates()
  {
    var days = 0, _table, _loopdates, 
        ...
        _interes_amount = $("#txt_interes").val(), 
        _capital_amount = $("#txt_capital").val(), 
        _loans_total = parseFloat(_loans_amount), 
        _cuota = parseFloat(_loans_total) / parseFloat(_duration), 
        _cuota_amount = $("#txt_loanstype_interes").val(),
        _total_interes = 0,
        _total_capital = 0,
        _total_cuota = 0,
        _start_date = new Date($("#txt_start_date").val()),
        i, _table = '<table class="table table-striped table-bordered table-hover"><tbody><tr><th style="width: 10px">#</th><th>Fecha</th><th>Saldo inicial</th><th>Interes</th><th>Capital</th><th>Cuota</th><th>Saldo final</th></tr>';
        
    $("#txt_cuota_amount").val(_cuota_amount);
    $("#txt_interes_amount").val(_interes_amount);
    $("#txt_capital_amount").val(_capital_amount);
    $("#txt_loans_total").val(_loans_total);

    $("#gridbox_amortization").html('');
    
    _table += '<tr><td>Inicio</td><td>'+$("#txt_entry_date").val()+'</td><td>'+addCommas(_loans_amount)+'</td><td></td><td></td><td></td><td></td></tr>';

    _loans_total = _duration*(parseFloat(_interes_amount)+parseFloat(_capital_amount)) - (parseFloat(_interes_amount)+parseFloat(_capital_amount));
    ...
    for (i = 0; i < _duration; i++)
    {
      ...
      //} else { alert("Fecha inválida"); }
        ...
        _table += '<td>'+addCommas(_capital_amount)+'</td>';
        _table += '<td>'+addCommas(_cuota_amount)+'</td>';
        _table += '<td></td>';
        _table += '</tr>';

        _total_capital += parseFloat(_capital_amount);
        _total_interes += parseFloat(_interes_amount);
        _total_cuota += parseFloat(_cuota_amount);
        _loans_total -= (_total_capital + _total_interes);
    }
    ...
    _table += '<td></td>';
    _table += '<td></td>';
    _table += '<td>'+addCommas(_total_interes)+'</td>';
    _table += '<td>'+addCommas(_total_capital)+'</td>';
    _table += '<td>'+addCommas(_total_cuota)+'</td>';
    _table += '<td>0.00</td>';
    _table += '</tr>';
