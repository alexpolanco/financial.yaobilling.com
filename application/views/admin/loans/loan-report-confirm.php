...
<body>
<div id="non-printable" style="position:fixed;">
	<center>
...
<div id="div_wrapper" style="width:100%;height:250px;border: solid #000 .5px;">
	...
	if($company[0]->company_image != '' && $company[0]->recipe_print == 'yes') { 
        ...
        <tr>
            <td align="right"><span class="font10 bold">Pagare N.°: <?php echo $row->payment_no; ?></span></td>
        </tr>
        <?php
		}
    }
	if($company[0]->recipe_print != 'yes'){ ?>
        <tr>
		    ...
		    <td><span class="font10" bold>Pagare N.°: <?php echo $row->payment_no; ?></span></td>
    	</tr>
	<?php } ?>
    	<tr>
