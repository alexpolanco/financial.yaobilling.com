...
$pdf->SetTitle($order[0]->customer_first_name.' Préstamo No. '.$order[0]->loans_no.' Reporte de Préstamo '.($loansdue ? 'Fuera de Fecha (' : 'Activo (').date("d-m-Y").')');
$pdf->SetSubject('PDF');
...
// create some HTML content
	...
	<table width="100%" border="1"> 
		<tr align="left">
			...
			<td rowspan="2" width="35%">
				<table width="100%">
					...
					<tr>
						<td width="47.5%"> Tipo de préstamo</td>
						<td width="5%">:</td>
						<td width="47.5%">'.$order[0]->loanstype_name.'</td>
					</tr>
					<tr>
      ...
      <tr align="left">
      	<td height="25"><br /><br /> CLIENTE: <h3> '.$order[0]->customer_first_name.'</h3>&nbsp;'.$order[0]->customer_address.' '.$order[0]->customer_city. '<br />&nbsp;'.$order[0]->customer_phone.'</td>
      </tr>
	</table> 
