  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="breadcrumb">
        <a href="<?php echo base_url().'guarantor/create'; ?>" class="btn btn-lg btn-primary" title="Nuevo garante">Nuevo Garante</a>
        <a target="_blank" href="<?php echo base_url().'guarantor/pdf'; ?>" class="btn btn-lg btn-danger" title="Exportar a PDF">PDF</a>
        <!-- <a target="_blank" href="<?php echo base_url().'guarantor/excel'; ?>" class="btn btn-lg btn-primary" title="Exportar a Excel">Excel</a> -->
      </div>
    </section>
        ...
        <div class="col-md-12">
            <div class="box">
              ...
              <?php 
                ...
                echo form_open('guarantor/delete',$attributes) ?>
                <table id="example" class="display table table-bordered table-hover">
                  ...
                  ?>
                      <tr data-child-value="<?php echo  $_recored->guarantor_id; ?>" data-child-is_active="<?php echo  $_recored->guarantor_is_active; ?>">
                        <td><?php echo $_recored->guarantor_first_name; ?></td>
                        <td><?php echo $_recored->guarantor_phone; ?></td>
                        <td></td>
                      </tr>
                  <?php 
                    }
...
function format(value, is_active) {
  base_url = '<?php echo base_url() ?>guarantor/';
  is_act = 'yes';
