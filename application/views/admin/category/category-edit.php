              ...
              <div class="box-body">
                ...
                <?php } ?>
			        <div class="form-group">
                        ...
                        <input type="text" name="txt_category_name" class="form-control " placeholder="Nombre de la categogía..." value="<?php echo $recored['category_name']; ?>" />
                    </div>
					         <div class="form-group">
                    ...
                    ?>       
                     <div class="form-group">
                        ...
                        <input type="radio" name="txt_category_is_active" <?php if($recored['category_is_active'] == 'yes') echo 'checked'; ?> placeholder="Está activa..." value="yes" /> Si
                        <input type="radio" name="txt_category_is_active" <?php if($recored['category_is_active'] == 'no') echo 'checked'; ?> placeholder="Está activa..." value="no" /> No
                    </div>
              </div>
            </div>
          </div>
