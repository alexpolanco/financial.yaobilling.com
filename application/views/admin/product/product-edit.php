        ...
        <div class="col-md-12">
            <div class="box box-primary">
              <div class="box-header">
                ...
                <a href="<?php echo base_url().'product'; ?>" class="btn btn-primary btn-small pull-right">Regresar</a>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                 <?php 
                ...
                $attributes = array('id' => 'frm','name'=>'frm');
                  ...
                  <div class="col-md-6">  
                    <div class="form-group">
                        ...
                        <input type="text" name="txt_product_name" class="form-control " placeholder="Nombre del producto..." value="<?php echo $recored['product_name']; ?>" />
                    </div>
					          <div class="form-group">
                        <label>Código :</label>
                        <input type="text" name="txt_product_serial_no" class="form-control " placeholder="Código del producto..." value="<?php echo $recored['product_serial_no']; ?>" />
                    </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="button" title="Cancelar" value="Cancel" class="btn btn-danger" onclick="javascript:window.location.href='<?php echo base_url().'product' ?>'" />
                    </div>
                  </div>
              <?php echo form_close(); ?>
              </div>
