                ...
                $attributes = array('id' => 'frm','name'=>'frm');
                  ...
                  <div class="col-md-6">
					...
					<div class="form-group">
                        ...
                        <input type="text" name="txt_product_name" class="form-control " placeholder="Nombre del producto..." value="" />
                    </div>
					<div class="form-group">
                        <label>Código :</label>
                        <input type="text" name="txt_product_serial_no" class="form-control " placeholder="Código del producto..." value="" />
                    </div>
