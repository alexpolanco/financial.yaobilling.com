...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Recibos <?php echo $loansdue; ?> (<?php echo count($recored); ?>)
      </h1>
      <div class="breadcrumb">
        <a href="<?php echo base_url().'loansfixed/loan_print'; ?>" class="btn btn-lg btn-primary">Generar recibos e imprimir</a>
        <button type="button" onclick="print_list('payment_list')" class="btn btn-lg btn-warning">Lista de cobro</button>
      </div>
    </section>
        ...
        <div class="col-md-12">
            <div class="box box-primary">
              ...
              <?php 
                ...
                echo form_open('loansfixed/receipt',$attributes) ?>
                <div class="row">
                      <div class="col-xs-2">
                      ...
                      <div class="col-xs-8">
                            <div class="form-group">
                              ...
                              <?php /*<input type="button" value="Recibos de hoy" title="Recibos de hoy" class="btn btn-<?php if($sendserver == 'today') echo 'success'; else echo 'primary'; ?>" onclick="javascript:window.location.href='<?php echo base_url().'loansfixed/today' ?>';" />
                              <input type="button" value="Esta semana" title="Esta semana" class="btn btn-<?php if($sendserver == 'weekly') echo 'success'; else echo 'primary'; ?>" onclick="javascript:window.location.href='<?php echo base_url().'loansfixed/weekly' ?>';" />
                              <input type="button" value="Este mes" title="Este mes" class="btn btn-<?php if($sendserver == 'monthly') echo 'success'; else echo 'primary'; ?>" onclick="javascript:window.location.href='<?php echo base_url().'loansfixed/monthly' ?>';" />
                              <input type="button" value="Este año" title="Este año" class="btn btn-<?php if($sendserver == 'yearly') echo 'success'; else echo 'primary'; ?>" onclick="javascript:window.location.href='<?php echo base_url().'loansfixed/yearly' ?>';" />
                              */ ?>
                              ...
                              <button type="button" class="btn btn-danger" onclick="javascript:window.location.href='<?php echo base_url() ?>loansfixed/receipt'"><i class="fa fa-eraser own-de-i"></i></button>
                            </div>
                         </div>
                </div>
                ...
                <table id="example" class="display" style="width:100%">
                  ...
                  ?>
                            <tr>
   								...
   								<td><?php echo $_recored->interes; ?></td>
				                ...
				                <td>
                                    ...
                                    <a href="<?php echo base_url() ?>loansfixed/loan_print/<?php echo $_recored->loans_no; ?>/<?php echo  $_recored->payment_no; ?>"><img src="<?php echo base_url() ?>_template/images/bprint.png" alt="print button" height="30" width="30" /></a>
                              </td>
                            </tr>
                  <?php 
                     }
...
<script type="text/javascript">
  ...
  {
    url = '<?php echo base_url() ?>loansfixed/pdf/'+url+'/'+_loanno;
  ...
  function print_list(url)
  {
    ...
    url = '<?php echo base_url() ?>loansfixed/pdf/'+url+'/'+dateform+'/'+dateto+loansdue<?php echo empty($loansdue) || empty($sendserver_due) ? '' : "+'/due'" ?>;
