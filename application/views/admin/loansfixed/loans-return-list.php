                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  ?>
                            <tr>
                                ...
                                <a href="<?php echo base_url() ?>loansfixed/bill_print/<?php echo $_recored->purchase_no; ?>"><img src="<?php echo base_url() ?>_template/images/bprint.png" height="30" width="30" /></a>

                                <a class="action-edit btn btn-info btn-sm" href="<?php echo base_url().'loansfixed/edit/'.$_recored->purchase_no; ?>" class="action-edit" title="Editar"><i class="fa fa-edit"></i></a>
                                <a class="action-edit btn btn-danger btn-sm" href="<?php echo base_url().'loansfixed/delete/'.$_recored->purchase_no; ?>" class="action-edit" title="Eliminar"><i class="fa fa-close"></i></a>
                              </td>
...
<script type="text/javascript">
  ...
  {
    url = '<?php echo base_url() ?>loansfixed/pdf/'+url+'/'+_orderno;
