...
?>
  ...
  <?php echo form_open('loansfixed/update/'.$this->uri->segment(3), array('onsubmit' => 'return stopform();','id' => 'frm','name'=>'frm'));?>

    <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>Editar Préstamo de Tasa Fija <b><?php echo $recored[0]->customer_first_name; ?></b></h1>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              <div class="input-group input-group-lg">    
                                ...
                                <input type="number" name="txt_contract_number" id="txt_contract_number" class="form-control " value="<?php echo $recored[0]->contract_number; ?>" onkeypress="return tabE(this,event,'txt_contract_folio1')" min="0" placeholder="Número de acto autentico..."  />
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              <div class="input-group input-group-lg">    
                                ...
                                <input type="number" name="txt_contract_folio1" id="txt_contract_folio1" class="form-control " value="<?php echo $recored[0]->contract_folio1; ?>" onkeypress="return tabE(this,event,'txt_contract_folio2')" min="0" placeholder="Número de folio 1..."  />
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              <div class="input-group input-group-lg">    
                                ...
                                <input type="number" name="txt_contract_folio2" id="txt_contract_folio2" class="form-control " value="<?php echo $recored[0]->contract_folio2; ?>" onkeypress="return tabE(this,event,'txt_entry_date')" min="0" placeholder="Número de folio 2..."  />
                              </div>
                            </div>
                          </div>
                        </div>
