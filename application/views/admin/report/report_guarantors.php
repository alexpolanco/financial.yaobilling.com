...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Reporte de Garantes</h1>
      <div class="breadcrumb">
        <a target="_blank" href="<?php echo base_url().'report/pdf/c/'.$dateform.'/'.$dateto.'/guarantors'; ?>" class="btn btn-danger btn-lg" style="margin-right: 5px;">Exportar a PDF</a>
        <!-- <a target="_blank" href="<?php echo base_url().'report/excel/c/'.$dateform.'/'.$dateto.'/guarantors'; ?>" class="btn btn-success btn-lg" style="margin-right: 5px;">Exportar a Excel</a> -->
      </div>
    </section>
      ...
      <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
              ...
              echo form_open('report/guarantors',$attributes) ?>
              <div class="box-body">
