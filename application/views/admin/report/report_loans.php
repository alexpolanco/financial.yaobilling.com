...
?>
  ...
  <?php 
    ...
    echo form_open('report/report_loans',$attributes) ?>

    <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>Reporte de prestamos</h1>
      <div class="breadcrumb">
        <a target="_blank" href="<?php echo base_url().'report/pdf'.'/'.$loanstype.'/'.$dateform.'/'.$dateto.'/loans'; ?>" class="btn btn-danger btn-lg pull-right" style="margin-right: 5px;">Exportar a PDF</a>
        <!-- <a target="_blank" href="<?php echo base_url().'report/excel'.'/'.$loanstype.'/'.$dateform.'/'.$dateto.'/loans'; ?>" class="btn btn-success btn-lg btn-lg" style="margin-right: 5px;">Exportar a Excel</a> -->
      </div>
    </section>
                        ...
                        <?php 
                          ...
                          foreach ($order as $_date) {
                            ...
                            <tr>
                              ...
                              <td><?php echo number_format($_date->due_amount,2); ?></td>
                              <td><?php echo number_format($_date->interes_amount,2); ?></td>
                              <td><?php echo number_format($total_ia,2); ?></td>
                            </tr>
                            <?php
                          }
                        ?>      
    ...
    $('#example1').DataTable({
      language: {
        ...
        footerCallback: function (row, data, start, end, display) {
            ...
            $(api.column(4).footer()).html(addCommas(total_interes));
            $(api.column(5).footer()).html(addCommas(total_actual));
        },
    });
  });
  // get loanstype
