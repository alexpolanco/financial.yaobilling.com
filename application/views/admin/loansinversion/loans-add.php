...
?>
  ...
  <?php echo form_open('loansinversion/create', array('onsubmit' => 'return stopform();','id' => 'frm','name'=>'frm'));?>

    <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>Agregar Préstamo de Inversión</h1>
            ...
            <div class='box-body pad'>
                <div class="row">
                      ...
                      <div class="input-group input-group-lg">
                        ...
                        <input type="number" name="txt_loanstype_interes" id="txt_loanstype_interes" class="form-control " data-inputmask='"mask": "99%"' data-mask="" step='0.01' value="10" onChange="updateLoanDates()" onkeypress="return tabE(this,event,'txt_loanstype_frequency')" min="1" placeholder="Tasa de intéres..." />
                        <span class="input-group-btn">
                      ...
                      <div class="row">
                        ...
                        <div class="input-group input-group-lg">
                          <div class="input-group-btn">
                            <button type="button" class="btn btn-default dropdown-toggle">Cantidad de <span class="loantime">meses</span></button>
                          </div>
                          <input type="number" name="txt_loanstype_duration" id="txt_loanstype_duration" class="form-control " value="12" onChange="updateLoanDates()" onkeypress="return tabE(this,event,'txt_contract_number')" min="1" placeholder="Cantidad de cuotas..."  />
                        </div>
                        <br />
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              <div class="input-group input-group-lg">    
                                ...
                                <input type="text" name="txt_contract_number" id="txt_contract_number" class="form-control " value="" onkeypress="return tabE(this,event,'txt_entry_time')" min="0" placeholder="Número de acto autentico..."  />
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              <div class="input-group input-group-lg">    
                                ...
                                <input type="time" name="txt_entry_time" id="txt_entry_time" class="form-control " value="<?php echo date('H:i') ?>" onkeypress="return tabE(this,event,'fsubmit')" min="0" placeholder="Hora del contrato..."  />
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          <div class="input-group input-group-lg">    
                            ...
                            <input type="date" name="txt_end_date" id="txt_end_date" class="form-control " value="" min="0" placeholder="Fecha de vencimiento..." readonly  />
                          </div>
                        </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="text-right">
                              ...
                              <input type="hidden" name="txt_loanstype_id" id="txt_loanstype_id" value="<?php echo $_loanstype[0]->loanstype_id; ?>" />
...
// update loan dates
  function updateLoanDates()
  {
    ...
    _table += '<tr><td>Inicio</td><td>'+$("#txt_entry_date").val()+'</td><td>'+addCommas(_loans_amount)+'</td><td></td><td>'+addCommas(_duration*_interes_amount)+'</td></tr>';

    _loans_total = _duration*_interes_amount - _interes_amount;
    ...
    _table += '<td>'+addCommas(_duration*_interes_amount)+'</td>';
    _table += '<td>0.00</td>';
    _table += '</tr>';
    ...
    _table_intro = '<table class="table table-striped table-bordered table-hover"><tbody><tr><th style="width: 10px">Monto prestado</th><th>Duración</th><th><span class="loantime" style="text-transform: capitalize">Meses</span> transcurridos</th><th>Interes acumulado</th><th>Saldo actual</th></tr>';
    _monthDiff = monthDiff(new Date($("#txt_entry_date").val()));

    _table_intro += '<tr><td>'+addCommas(_loans_amount)+'</td><td>'+_duration+' <span class="loantime">meses</span></td><td>'+_monthDiff+'</td><td>'+addCommas(_monthDiff*_interes_amount)+'</td><td>'+addCommas(parseFloat(_monthDiff*_interes_amount) + parseFloat(_loans_amount))+'</td></tr></table><br>';
