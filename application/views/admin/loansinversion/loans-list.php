...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Préstamos de Inversión <?php echo empty($loansdue) ? 'activos' : $loansdue ; ?> (<?php echo count($recored); ?>)
      </h1>
      <div class="breadcrumb">
        <?php if($loans_origen == 'due') : ?>
        <a id="loans" href="<?php echo base_url().'loansinversion'; ?>" class="btn btn-lg btn-success">Préstamos activos</a>
        <?php else : ?>
        <a id="loans_due" href="<?php echo base_url().'loansinversion/due'; ?>" class="btn btn-lg btn-danger">Préstamos saldados</a>
				<?php endif; ?>
        <!-- <a id="receipts" href="<?php echo base_url().'loansinversion/receipt'; ?>" class="btn btn-lg btn-success">Recibos</a> -->
        <a id="new_loan" href="<?php echo base_url().'loansinversion/create'; ?>" class="btn btn-lg btn-primary">Nuevo Préstamo</a> 
      </div>
    </section>
        ...
        <div class="col-md-12">
            <div class="box box-primary">
              ...
              <?php 
                ...
                echo form_open('loansinversion/delete',$attributes) ?>
      ...
      <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
          ...
          <?php 
                ...
                echo form_open('loansinversion/pay',$attributes) ?>
      ...
      <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
          ...
          <?php 
                ...
                echo form_open('loansinversion/additional',$attributes) ?>
                <div class="modal-body">
...
<div class="modal modal-success fade in" tabindex="-1" role="dialog" id="completeLoanModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      echo form_open('loansinversion/edit/completeLoan',$attributes) ?>
        <div class="modal-body">
...
<div class="modal modal-danger fade in" tabindex="-1" role="dialog" id="removeTransactionModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      echo form_open('loansinversion/delete/removeTransaction',$attributes) ?>
        <div class="modal-body">
...
<div class="modal modal-danger fade in" tabindex="-1" role="dialog" id="removeAdditionalModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      echo form_open('loansinversion/delete/removeAdditional',$attributes) ?>
        <div class="modal-body">
...
function format(value, name, loans_amount, current_balance, interes_amount, capital, interes, unpaid_payments, due_date) {
  base_url = '<?php echo base_url() ?>loansinversion/';
...
$(document).ready(function(){
  ...
  {
    url = '<?php echo base_url() ?>loansinversion/pdf/loan_letter/'+_loanno;
  ...
  {
    url = '<?php echo base_url() ?>loansinversion/pdf/loan_1/'+_loanno;
  ...
  {
    url = '<?php echo base_url() ?>loansinversion/pdf/loan_contract/'+_loanno;
  ...
  {
    url = '<?php echo base_url() ?>loansinversion/pdf/loan_receipt/'+_loanno+'/'+_transno;
    ...
    function updateOrderTransactionsTable(id, due = "")
{
  if(id) {
    $.ajax({
        type: "GET",
        url: "<?php echo base_url() ?>ajax/getloansinversiontransactions/index",
...
function updateAdditionalTable(id)
  {
    if(id) {
      $.ajax({
          type: "GET",
          url: "<?php echo base_url() ?>ajax/getloansinversionadditional/index",
          data: {"<?php echo $this->security->get_csrf_token_name(); ?>":"<?php echo $this->security->get_csrf_hash(); ?>",'id':id}
      }).done(function( msg ) { 
