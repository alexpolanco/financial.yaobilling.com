                        ...
                        <div class="row">
                          ...
                          <div class="form-group">
                            <div class="input-group input-group-lg">    
                              ...
                              <input type="date" name="txt_start_date" id="txt_start_date" class="form-control " value="<?php echo date('Y-m-d'); ?>" onkeypress="return tabE(this,event,'fsubmit')" onChange="updateLoanDates()" min="0" placeholder="Fecha de inicio..."  />
                            </div>
                          </div>
                          </div></div>
                          <div class="row">
