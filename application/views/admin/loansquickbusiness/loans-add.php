...
?>
  ...
  <?php echo form_open('loansquickbusiness/create', array('onsubmit' => 'return stopform();','id' => 'frm','name'=>'frm'));?>

    <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>Agregar Préstamo Rápido</h1>
      <div class="breadcrumb">
        <input type="submit" name="btnsubmit" id="fsubmit" class="btn btn-lg btn-primary" value="Guardar" />
        <input type="button" title="Regresar" value="Regresar" class="btn btn-lg btn-warning" onclick="javascript:window.location.href='<?php echo base_url().'loansquickbusiness' ?>'" />
      </div>
    </section>
    <!-- Main content -->
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              <div class="input-group input-group-lg">    
                                ...
                                <input type="time" name="txt_entry_time" id="txt_entry_time" class="form-control " value="<?php echo date('H:i') ?>" onkeypress="return tabE(this,event,'txt_loanstype_duration')" min="0" placeholder="Hora del contrato..."  />
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <div class="input-group input-group-lg">
                              ...
                              <input type="number" name="txt_loanstype_duration" id="txt_loanstype_duration" class="form-control " value="1" min="1" onChange="updateLoanDates()" onkeypress="return tabE(this,event,'txt_guarantor1')" placeholder="Cantidad de meses..." />
                            </div>
                          </div>
                        </div>
                      </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              <div class="input-group input-group-lg">    
                                ...
                                <input type="date" name="txt_end_date" id="txt_end_date" class="form-control " value="<?php echo date('Y-m-d') ?>" placeholder="Fecha de vencimiento..." readonly />
                              </div>
                            </div>
                          </div>
                        </div>
...
// update loan dates
  function updateLoanDates()
  {
    ...
    _table += '<tr><td>Contrato</td><td>'+$("#txt_entry_date").val()+'</td><td>'+addCommas(_loans_amount)+'</td><td></td><td></td></tr>';
    _loans_total += parseFloat(_interes_amount);
    ...
    for (i = 0; i < _duration; i++)
    {
      ...
      //} else { alert("Fecha inválida"); }
        ...
        _table += '<td>'+addCommas(parseFloat(_loans_total))+'</td>';
        _table += '</tr>';
    ...
    _table += '<td>'+addCommas(_interes_amount)+'</td>';
    _table += '<td>'+addCommas(parseFloat(_loans_total) - parseFloat(_interes_amount))+'</td>';
    _table += '</tr>';
    ...
    _table_intro = '<table class="table table-striped table-bordered table-hover"><tbody><tr><th style="width: 10px">Duración</th><th>Monto prestado</th><th>Monto de interes</th><th>Saldo</th></tr>';

    _table_intro += '<tr><td>'+_duration+' meses</td><td>'+addCommas(_loans_amount)+'</td><td>'+addCommas(_interes_amount)+'</td><td>'+addCommas(parseFloat(_loans_total) - parseFloat(_interes_amount))+'</td></tr></table><br>';
