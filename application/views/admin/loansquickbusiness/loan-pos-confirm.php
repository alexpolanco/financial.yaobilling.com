...
$bill_date = date("d-m-Y", strtotime($bill_date));
	...
	if(!empty($grand))
	{
		$s_t=$grand['grand_loans_tax'];
		$s_t_v=$grand['grand_loans_tax_value'];
...
<div class="invoice_container">
    ...
    <p id="ctl00_content_InvoiceMini1_pAddress" class="address">
        <?php echo strip_tags($company[0]->company_address); ?>, <?php echo htmlspecialchars($company[0]->company_city); ?>.<br /> <?php echo htmlspecialchars($company[0]->company_phone); ?>
    </p>
    

    <div class="dotseparator"></div>

    <h2 id="ctl00_content_InvoiceMini1_lblInvoiceNumber">Factura #<?php echo $order_no; ?></h2>
	...
	<p class="invDate" style="padding-left:10px;">UNID.</p>
	<p class="invDate">CANT. &nbsp; X &nbsp; PRECIO</p>
	<p class="invDate" style="padding-right:55px;">PRODUCTO</p>
...
<table class="rightAuto" cellpadding="0" cellspacing="0">
    ...
    <tr><th><?php echo $totalQTY; ?>&nbsp;&nbsp;TOTAL</th><td class='sep'>:</td><td class='currency'></td><td style=''><?php echo $grand_tot; ?></td></tr>
    ...
    <div class="section">
        ...
        <div id="ctl00_content_InvoiceMini1_sectionPayment" class="section_content_right">
            PAGO<div style="font-weight: normal;">
    ...
    <div id="ctl00_content_InvoiceMini1_divNote" class="note"><p style="text-align:center;font-weight:700;font-size:15px;"><strong>AHORRO  <?php echo abs($save); ?></strong></p>

<footer>¡Gracias por su compra!</footer></div>
...
<div id="non-printable">
    ...
    <a href="<?php echo base_url(); ?>loansfixed" class="">Préstamos</a>
  </center>
</div>
<script>
