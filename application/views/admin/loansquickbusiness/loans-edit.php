...
?>
  ...
  <?php echo form_open('loansquickbusiness/update/'.$this->uri->segment(3), array('onsubmit' => 'return stopform();','id' => 'frm','name'=>'frm'));?>

    <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>Editar Préstamo Rápido <b><?php echo $recored[0]->customer_first_name; ?></b></h1>
            ...
            <div class='box-body pad'>
                ...
                <div class="row" id="customers" style="display:none;">
                  ...
                  <div class="input-group input-group-lg">
                    ...
                    <input type="number" name="txt_loanstype_interes" id="txt_loanstype_interes" class="form-control " data-inputmask='"mask": "99%"' data-mask="" value="<?php echo $recored[0]->interes; ?>" onChange="updateLoanDates()" onkeypress="return tabE(this,event,'txt_contract_number')" min="1" placeholder="Intéres..." />
                  </div>
                  <br />
                    <div class="row">
                          <div class="col-md-12">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              <div class="input-group input-group-lg">    
                                ...
                                <input type="time" name="txt_entry_time" id="txt_entry_time" class="form-control " value="<?php echo $recored[0]->entry_time; ?>" min="0" onkeypress="return tabE(this,event,'txt_loanstype_duration')" placeholder="Hora del contrato..."  />
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="input-group input-group-lg">
                          ...
                          <input type="number" name="txt_loanstype_duration" id="txt_loanstype_duration" class="form-control " value="<?php echo $recored[0]->duration; ?>" onChange="updateLoanDates()" onkeypress="return tabE(this,event,'txt_guarantor1')" min="1" placeholder="Cantidad de meses..." />
                        </div>
                  ...
                  <div class='col-md-6 pad-0  info-for-bill' >
                    <div class='box box-primary' >
                      <div class='box-body pad'>
                        ...
                        <input type="hidden" name="txt_loanstype_id" id="txt_loanstype_id" value="<?php echo $recored[0]->loanstype_id; ?>" />
